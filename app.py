...
#         # Storing selected options in session
#         selected_options = session.get('selected_options', {})
#         selected_options[question_num] = selected_option
...
#     return render_template('mcq.html', category=category, question_num=question_num, question=question, options=options)
